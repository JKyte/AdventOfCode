...
import advent2017.day04.HighEntropyPassphrases;
...
public class HighEntropyPassphrasesTest {
    ...
    public void testExample1() {
        ...
        HighEntropyPassphrases passphrases = new HighEntropyPassphrases(input);
        assertEquals(1, passphrases.countValidPassphrases());
    }
    ...
    public void testExample2() {
        ...
        HighEntropyPassphrases passphrases = new HighEntropyPassphrases(input);
        assertEquals(0, passphrases.countValidPassphrases());
    }
    ...
    public void testPartOne() {
        HighEntropyPassphrases passphrases = new HighEntropyPassphrases(problemInput);
        assertEquals(477, passphrases.countValidPassphrases());
    }
    ...
    public void testExample4() {
        ...
        HighEntropyPassphrases passphrases = new HighEntropyPassphrases(input);
        assertEquals(1, passphrases.countValidPassphrasesV2());
    }
    ...
    public void testExample5() {
        ...
        HighEntropyPassphrases passphrases = new HighEntropyPassphrases(input);
        assertEquals(0, passphrases.countValidPassphrasesV2());
    }
    ...
    public void testPartTwo() {
        HighEntropyPassphrases passphrases = new HighEntropyPassphrases(problemInput);
        assertEquals(167, passphrases.countValidPassphrasesV2());
    }

    String problemInput = "una bokpr ftz ryw nau yknf fguaczl anu\n" +
