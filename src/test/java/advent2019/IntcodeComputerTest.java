...
public class IntcodeComputerTest {
    ...
    public void testAdvent2019Day02Part2() {
        ...
        long[] input = {1, 71, 95, 3, 1, 1, 2, 3, 1, 3, 4, 3, 1, 5, 0, 3, 2, 1, 9, 19, 1, 10, 19, 23, 2, 9, 23, 27, 1, 6, 27, 31, 2, 31, 9, 35, 1, 5, 35, 39, 1, 10, 39, 43, 1, 10, 43, 47, 2, 13, 47, 51, 1, 10, 51, 55, 2, 55, 10, 59, 1, 9, 59, 63, 2, 6, 63, 67, 1, 5, 67, 71, 1, 71, 5, 75, 1, 5, 75, 79, 2, 79, 13, 83, 1, 83, 5, 87, 2, 6, 87, 91, 1, 5, 91, 95, 1, 95, 9, 99, 1, 99, 6, 103, 1, 103, 13, 107, 1, 107, 5, 111, 2, 111, 13, 115, 1, 115, 6, 119, 1, 6, 119, 123, 2, 123, 13, 127, 1, 10, 127, 131, 1, 131, 2, 135, 1, 135, 5, 0, 99, 2, 14, 0, 0};
        IntcodeComputer computer = new IntcodeComputer(input);
        computer.run();
    ...
    public void testAdvent2019Day05Example7_position() {
        long[] input = {3, 12, 6, 12, 15, 1, 13, 14, 13, 4, 13, 99, -1, 0, 1, 9}; //  Position mode
        IntcodeComputer computer = new IntcodeComputer(input);
    ...
    public void testAdvent2019Day05Example7_immediate_negativeInput() {
        long[] input = {3, 3, 1105, -1, 9, 1101, 0, 0, 12, 4, 12, 99, 1}; // Immediate mode
        IntcodeComputer computer = new IntcodeComputer(input);
        testWithInput(computer, "-1");
        assertEquals(1, computer.getOutputs().get(0).intValue());
    }
    ...
    public void testAdvent2019Day05Example8_7() {
        long[] input = {3, 21, 1008, 21, 8, 20, 1005, 20, 22, 107, 8, 21, 20, 1006, 20, 31,
    ...
    private void testInputsAndOutputs(long[] program, String[] inputs, String[] outputs) {
        for (int ii = 0; ii < inputs.length; ii++) {
            testInputsAndOutputs(program, inputs[ii], outputs[ii]);
        }
    }

    private void testInputsAndOutputs(long[] program, String input, String output) {
