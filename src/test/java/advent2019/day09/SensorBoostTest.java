...
public class SensorBoostTest {
    ...
    public void testOpcode9() {
         ...
         */
        long[] program = {109, 19, 204, -34, 99};
        IntcodeComputer computer = new IntcodeComputer(program);
        computer.setRelativeBase(2000L);
        computer.setValueAtIndex(1985, 123457890L);
        computer.run();

        assertEquals(2019L, computer.getRelativeBase());
        assertEquals(123457890L, computer.getLastOutput());
    }

    @Test
    public void testCopyProgram() {
        //  takes no input and produces a copy of itself as output.
        long[] program = {109, 1, 204, -1, 1001, 100, 1, 100, 1008, 100, 16, 101, 1006, 101, 0, 99};
        IntcodeComputer computer = new IntcodeComputer(program);
        computer.run();
        //  Should produce itself.
        long[] outputs = Longs.toArray(computer.getOutputs());
        assertArrayEquals(program, outputs);
    }

    @Test
    public void testOutputSixteenDigitNumber() {
        //  should output a 16-digit number.
        long[] program = {1102, 34915192, 34915192, 7, 4, 7, 99, 0};
        IntcodeComputer computer = new IntcodeComputer(program);
        computer.run();
        assertEquals(16, Long.toString(computer.getLastOutput()).length());
    }
