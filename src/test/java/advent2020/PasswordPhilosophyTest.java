...
import advent2020.day02.PasswordPhilosophy;
...
public class PasswordPhilosophyTest {
    ...
    public void testExample1() {
        ...
        PasswordPhilosophy philosophy = new PasswordPhilosophy(input);
        assertEquals(1, philosophy.countValidPasswords());
    }
    ...
    public void testExample2() {
        ...
        PasswordPhilosophy philosophy = new PasswordPhilosophy(input);
        assertEquals(0, philosophy.countValidPasswords());
    }

    @Test
    public void testExample3() {
        String input = "2-9 c: ccccccccc";
        PasswordPhilosophy philosophy = new PasswordPhilosophy(input);
        assertEquals(1, philosophy.countValidPasswords());
    }
    ...
    public void testPart1() {
        PasswordPhilosophy philosophy = new PasswordPhilosophy(problemInput);
        assertEquals(548, philosophy.countValidPasswords());
    }
    ...
    public void testExample4() {
        String input = "1-3 a: abcde";
        PasswordPhilosophy philosophy = new PasswordPhilosophy(input);
        assertEquals(1, philosophy.countValidPasswordsV2());
    }
    ...
    public void testExample5() {
        String input = "1-3 b: cdefg";
        PasswordPhilosophy philosophy = new PasswordPhilosophy(input);
        assertEquals(0, philosophy.countValidPasswordsV2());
    }
    ...
    public void testPart2() {
        PasswordPhilosophy philosophy = new PasswordPhilosophy(problemInput);
        assertEquals(502, philosophy.countValidPasswordsV2());
    }

    private String problemInput = "1-14 b: bbbbbbbbbbbbbbbbbbb\n" +
