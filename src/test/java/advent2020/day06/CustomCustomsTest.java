...
public class CustomCustomsTest {
    ...
    public void testExample1() {
        ...
        assertEquals(6, customs.countGroupsAny(input));
    }
    ...
    public void testExample2() {
        String input = "abc\n" +
                ...
                "b";
        CustomCustoms customs = new CustomCustoms();
        assertEquals(11, customs.countGroupsAny(input));
    }

    @Test
    public void testPartOne() {
        CustomCustoms customs = new CustomCustoms();
        assertEquals(6532, customs.countGroupsAny(puzzleInput));
    }
    ...
    public void testExample3() {
        String input = "abc\n" +
                ...
                "b";
        CustomCustoms customs = new CustomCustoms();
        assertEquals(6, customs.countGroupsAll(input));
    }

    @Test
    public void testPartTwo() {
        CustomCustoms customs = new CustomCustoms();
        assertEquals(3427, customs.countGroupsAll(puzzleInput));
    }

    private String puzzleInput = "qtmdwspah\n" +
            "sqwdamhpt\n" +
            "phwdaqsmt\n" +
            "stmdqwhap\n" +
            "pqawdhtms\n" +
