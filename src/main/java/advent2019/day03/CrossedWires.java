...
//        String wireTwo = "U98,R91,D20,R16,D67,R40,U7,R15,U6,R7";    //  Steps is 410
    ...
    public static Set<MyPoint> generatePoints(String wire) {
        ...
        System.out.println("Wire has " + chunks.length + " chunks");
...
//                        System.out.println("right");
                ...
                steps++;
                points.add(new MyPoint(curX, curY, steps));
            }
        }
        return points;
    }
    ...
    private static class MyPoint extends Point {
        ...
        public MyPoint(int x, int y, int steps) {
            super(x, y);
            this.steps = steps;
        }
